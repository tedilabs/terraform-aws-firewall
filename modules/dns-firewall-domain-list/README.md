...
| <a name="input_domains"></a> [domains](#input\_domains) | (Optional) A set of domains for the firewall domain list. | `set(string)` | `[]` | no |
...
| <a name="output_domains"></a> [domains](#output\_domains) | The set of domains from the firewall domain list. |
